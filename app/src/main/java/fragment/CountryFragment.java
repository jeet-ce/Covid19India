...
public class CountryFragment extends Fragment implements ConnectivityReceiver.ConnectivityReceiverListner{
    ...
    private void checkInternetConnection() {
        ...
        if(isConnected){
            ...
            PieChart pieChart = myView.findViewById(R.id.indSummaryPie);
            ...
            viewModel.getCountryData().observe(this, new Observer<CountryModel>() {
                ...
                public void onChanged(CountryModel countryModel) {
                    ...
                    pieEntries.add(new PieEntry(countryModel.getConfirmed(), getResources().getString(R.string.confirmed)));
                    ...
                    pieEntries.add(new PieEntry(countryModel.getActive(),"Active"));
